...
<div class="kuhinja">
 ...
 <div class="kuhinja--midd">
    ...
    $taxonomy = get_object_taxonomies( array( 'post_type' => 'kitchen' ) );
    ...
    ?>
  <div class="kuhinja--midd-link" id="<?php echo $term->term_id ?>"><a href="#" onclick="<?php $termChoioce = $term->name ?>"><?php echo $term->name ?></a></div>
    <?php
      }
    }
